...
public class Swagger2Config {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                //扫描的包路径
                .apis(RequestHandlerSelectors.basePackage("com.lczyfz"))
    ...
    @Bean
    public Docket createRestApiExamSystem() {
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(apiInfo())
                .select()
                //扫描的包路径
                .apis(RequestHandlerSelectors.basePackage("com.lczyfz.edp.springboot.demo.sys"))
                .paths(PathSelectors.any())
                .build()
                .groupName("考试服务系统接口");
    }
